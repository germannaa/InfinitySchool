...
class Humano:
    #Atributos
    def __init__(self, nome, sobrenome, anoNascimento, email, cpf, numCartao, som):
        self.nome = nome
    ...
    #Métodos
    #Trocar por respirando, criar lista para possiveis respostas positivas.
    def falar(self, som):
        lista_sons = ["oi", "blabla", "33"]
        if som in lista_sons:
            print("Parabens! É um humano")
        else:
            print("Isso é tudo, menos humano!")
...
numCartao = input("Digite o numero do seu cartao:")
som = input("Você fala algo? Que som vc faz? Fale 33")

humano = Humano(nome,sobrenome, anoNascimento, email, cpf, numCartao, som)
